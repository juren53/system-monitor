        ...
        try:
            ...
            for line in result.stdout.split('\n'):
                if "Network" in line:
                    ...
                    subprocess.run(['import', '-window', window_id, 'images/dialog-network-realtime.png'])
                    print("✓ Screenshot saved: images/dialog-network-realtime.png")
                    break
