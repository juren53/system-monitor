"""
icon_loader.py
A robust, cross-platform icon loader for PyQt5 applications.
...
class IconLoader:
    ...
    def set_taskbar_icon(self, window, app_id: str = "com.sysmon.app") -> None:
        """
        ...
        app_id : str
            The AppUserModelID string for this window (default "com.sysmon.app").
        """
...
def _init_win32(app_id: str = "com.sysmon.app") -> None:
